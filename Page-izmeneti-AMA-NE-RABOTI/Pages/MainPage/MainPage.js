...
//console.log("SecurityTokeeen: " + securityToken1);
...
function fetchDataDoctors() {
    ...
    console.log("Before calling api /curandusproject/webapi/api/getprovidersdatabyprovider/ProviderProviderId");
...
function fetchData() {
    ...
    //console.log("Fisrt security token sent to this site is: " + securityToken1 + ", and second securityToken is: " + securityToken2);
    console.log("Before calling api /curandusproject/webapi/api/patients/providerId");
    ...
    fetch(urlPatient, {
        ...
        var flag = false;
        console.log("After calling api /curandusproject/webapi/api/patients/providerId");
        for (var i = contacts.length - 1; i >= 0; i--) {
            contacts[i].firstLetter = contacts[i].firstName.charAt(0).toUpperCase();
            contacts[i].fullName = SubstringName(contacts[i].firstName + " " + contacts[i].lastName);
            contacts[i].isLetter = 0;
...
function deleteDoctor(e) {
    ...
    Modal.showModal(
        ...
        function(s) {
            if (s == "Yes") {
                //   console.log("FIRST SECURITY TOKEN: " + securityToken1);
