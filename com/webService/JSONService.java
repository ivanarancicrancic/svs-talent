...
//	}
	   @GET
	   @Path("/generateSecurityToken")
	 //  @Produces("application/json")
	   public String GenerateSecurityToken() throws Exception 
		{
			...
			try{
				...
				token = projectManager.GenerateSecurityToken().getToken();
				//Gson gson = new Gson();
				//System.out.println(gson.toJson(token));
				//t_tems_str = gson.toJson(token);
//				if (t_items.isEmpty()){
...
//				{
   ...
   public List<TreatmentItemListRegid> getTreatmentItemListLoadPatient(@PathParam("patientid")int patientid, @PathParam("securityToken") String securityToken) throws Exception 
	{
	 ...
	 @POST
	 @Path("/insertpatient/securityToken={securityToken}")
	 @Consumes({MediaType.APPLICATION_JSON })
	 @Produces("application/json")
	 public String insertPatient(Patients p_patient, @PathParam("securityToken") String securityToken) {
		 System.out.println("init");
   ...
   public List<TreatmentItemListRegid> getTreatmentItemListScroll(@PathParam("treatmentitemlistid")int treatmentitemlistid, 
	...
	@POST
	@Path("/updatesavedtreatment/savedtreatmentid={savedtreatmentid}&securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	public String UpdateSavedTreatment(@PathParam("savedtreatmentid")int savedtreatmentid,List<TreatmentItem> t_items, @PathParam("securityToken") String securityToken) {
		ProjectManager projectManager= new ProjectManager();
		boolean flag=false;
		String t_tems_str = null;
		try {
	...
	@POST
	@Path("/UpdateActiveSubTreatment/subtreatmentid={p_subtreatmentid}&securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	public String InsertActiveSubTreatment(@PathParam("p_subtreatmentid") Integer p_subtreatmentid,List<TreatmentItem> t_items, @PathParam("securityToken") String securityToken) {
		ProjectManager projectManager= new ProjectManager();
...
//	+ "nametreatment={nametreatment : (.+)?}")
	@POST
	@Path("/insertsavedtreatment/securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	public String CheckNameSavedTreatment(@QueryParam("providerid") Integer providerid, @QueryParam("nametreatment") String nametreatment,
			List<TreatmentItem> t_items, @PathParam("securityToken") String securityToken) {	
		ProjectManager projectManager= new ProjectManager();
		int flag;
		String t_tems_str = null;
		try {
	...
	@Path("/InsertSavedTreatment/providerid={providerid}&"
			+ "nametreatment={nametreatment : (.+)?}&securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@Path("/InsertActiveSubTreatment/activetreatmentid={activetreatmentid}&providerid={providerid}&patientid={patientid}&"
			+ "nametreatment={nametreatment}&namesubtreatment={namesubtreatment}&securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@POST
	@Path("/insert/securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Providers createPro(Providers track, @PathParam("securityToken") String securityToken) {
	 ...
	 @POST
	 @Path("/insertprovider/securityToken={securityToken}")
	 @Consumes({MediaType.APPLICATION_JSON })
	 @Produces("application/json")
	 public String insertProvider(Providers p_provider, @PathParam("securityToken") String securityToken) {
		 System.out.println("init");
...
//			{
	...
	@Path("/addcontactpatient/providerId={providerID}&phone={phone}&firstName={firstName}"
			+ "&lastName={lastName}&chatid={chatid}&roomid={roomid}&securityToken={securityToken}")	
	@Produces("application/json")
   public String AddContactPatient(@PathParam("providerID")int providerID, @PathParam("phone")String phone,
			...
			@PathParam("chatid")String chatid, @PathParam("roomid")String roomid, @PathParam("securityToken") String securityToken)
	{
		boolean flag=false;
		String t_tems_str = null;
		try 
   ...
   public Patients getPatientData(@PathParam("patientId")int patientId, @PathParam("securityToken")String securityToken) throws Exception 
	...
	@POST
	@Path("/updatetreatmenitemlist/TreatmentItemListId={TreatmentItemListId}&securityToken={securityToken}")
	@Produces("application/json")
	@Consumes(MediaType.APPLICATION_JSON)
	public String updatetreatmenitemlist(@PathParam("TreatmentItemListId")int TreatmentItemListId,TreatmentItemList t_items, @PathParam("securityToken") String securityToken) {	
		ProjectManager projectManager= new ProjectManager();
   ...
   public String getprovidersdatabyprovider(@PathParam("ProviderProviderId")int ProviderProviderId, @PathParam("securityToken")String securityToken)
	...
	@POST
	@Path("/EndTreatment/ActiveTreatmentId={ActiveTreatmentId}&securityToken={securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces("application/json")
	public String EndTreatment(@PathParam("ActiveTreatmentId") Integer ActiveTreatmentId, @PathParam("securityToken") String securityToken) throws Exception  {	
		ProjectManager projectManager= new ProjectManager();
		boolean flag = false;
		String t_tems_str = null;
		try {
...
//			t_tems_str = gson.toJson(t_items);
	...
	@POST
	@Path("/inserttreatmentitemimage/securityToken={securityToken}") 
	@Consumes(MediaType.APPLICATION_JSON) //byte[] imageCode, TreatmentItem t_item
	@Produces("application/json") 
	public String InsertBase64Image(	TreatmentItem tmp, @PathParam("securityToken") String securityToken){ 
	ProjectManager projectManager= new ProjectManager(); 
	String t_item =""; 
	...
	@GET
	@Path("/deleteProviderProvider/{ProviderDetail1}&&{ProviderDetail2}&&{securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces("application/json")
	...
	@GET
	@Path("/deleteProviderPatient/{ProviderDetail}&&{PatientDetail}&&{securityToken}")
	@Consumes(MediaType.APPLICATION_JSON)
	public String deleteProviderPatient(@PathParam("ProviderDetail") Integer ProviderDetail,@PathParam("PatientDetail") Integer PatientDetail, @PathParam("securityToken")String securityToken) throws Exception  {	
	 ...
	 @POST
	 @Path("/updateProviderImageUrl/{providerId}&&{imageUrl}&&{name}&&{lastname}&&{securityToken}")
	 @Consumes(MediaType.APPLICATION_JSON)
	 public String updateProviderImageUrl(@PathParam("providerId") Integer providerId,@PathParam("imageUrl") String imageUrl, @PathParam("name") String name, @PathParam("lastname") String lastname, @PathParam("securityToken") String securityToken) throws Exception { 
	  ProjectManager projectManager= new ProjectManager();
	  boolean flag=false;
	  String t_tems_str = null;	  
		try {		
