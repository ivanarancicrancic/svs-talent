...
public class ProjectManager {
	...
	public VerificationToken GenerateSecurityToken() throws Exception {
		VerificationToken verificationToken = null;
		try {
			    Database database= new Database();
			    Connection connection = database.Get_Connection();
				Project project= new Project();
				verificationToken=project.generateSecurityToken(connection);
	...
	public boolean SendSMS(String To, String Body, String securityToken)  throws Exception {
		boolean flag = false;
		try {
			    Database database= new Database();
			    Connection connection = database.Get_Connection();
				Project project= new Project();
				flag=project.SendSMS(connection, To, Body, securityToken);
		} catch (Exception e) {
			throw e;
		}
		return flag;
...
{		
	...
	public Providers InsertProvider(Providers p_provider, String securityToken) throws Exception {
		Providers t_items= new Providers();
		try {
		    Database database= new Database();
		    Connection connection = database.Get_Connection();
...
//			t_items=project.InsertProvider(connection, p_provider);
			t_items=project.InsertProvider(connection, p_provider, securityToken);
