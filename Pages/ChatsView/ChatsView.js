...
function GetPatientsWtihTretmans() {
    final = [];
    requestsfinal = [];
    var urlPatient = activeUrl.URL + "/curandusproject/webapi/api/activecontacts/providerId=" + User.providerId + "&securityToken=" + securityToken;
    ...
    fetch(urlPatient, {
        ...
        console.log("Resultattt: " + JSON.stringify(response));
