...
public class ReminderNotification {
	...
	private Integer PATIENTNOTIFICATIONENABLED;
	...
	public ReminderNotification(Integer treatmentItemListId, Integer treatmentitem, String label, Date timeScheduled,
			...
			Integer notificationEnabled, String pATIENTREGID, Integer pATIENTNOTIFICATIONENABLED) {
		super();
		...
		PATIENTNOTIFICATIONENABLED = pATIENTNOTIFICATIONENABLED;
	}
	...
	public Integer getPATIENTNOTIFICATIONENABLED() {
		return PATIENTNOTIFICATIONENABLED;
	}

	public void setPATIENTNOTIFICATIONENABLED(Integer pATIENTNOTIFICATIONENABLED) {
		PATIENTNOTIFICATIONENABLED = pATIENTNOTIFICATIONENABLED;
	}
}
