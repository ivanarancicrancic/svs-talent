		...
		function capitalizeFirstLetter1() {

		    if (firstName.value != null) {
		        console.log("capitalizeFirstLetter1 CALLED!!!");
		        var pomName = firstName.value;
		        firstName.value = pomName.charAt(0).toUpperCase() + pomName.slice(1);
		    }
		    if (lastName.value != null) {
		        console.log("capitalizeFirstLetter2 CALLED!!!");
		        var pomName1 = lastName.value;
		        lastName.value = pomName1.charAt(0).toUpperCase() + pomName1.slice(1);
		    }

		    if (chronicDiseases.value != null) {
		        console.log("capitalizeFirstLetter2 CALLED!!!");
		        var pomName1 = chronicDiseases.value;
		        chronicDiseases.value = pomName1.charAt(0).toUpperCase() + pomName1.slice(1);
		    }

		    if (allergies.value != null) {
		        console.log("capitalizeFirstLetter2 CALLED!!!");
		        var pomName1 = allergies.value;
		        allergies.value = pomName1.charAt(0).toUpperCase() + pomName1.slice(1);
		    }
		    if (medicationsThatRecieves.value != null) {
		        console.log("capitalizeFirstLetter2 CALLED!!!");
		        var pomName1 = medicationsThatRecieves.value;
		        medicationsThatRecieves.value = pomName1.charAt(0).toUpperCase() + pomName1.slice(1);
		    }

		    if (additionalInnfo.value != null) {
		        console.log("capitalizeFirstLetter2 CALLED!!!");
		        var pomName1 = additionalInnfo.value;
		        additionalInnfo.value = pomName1.charAt(0).toUpperCase() + pomName1.slice(1);
		    }
		...
		module.exports = {
		    ...
		    capitalizeFirstLetter1: capitalizeFirstLetter1,
