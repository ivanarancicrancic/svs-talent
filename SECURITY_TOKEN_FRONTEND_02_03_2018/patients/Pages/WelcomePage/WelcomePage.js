...
Lifecycle.on("enteringInteractive", function() {
    ...
    console.log("BEFORE CALL generateSecurityToken IN WELCOME.enteringInteractive!");
    fetch(url1, {
        method: 'POST',
        headers: {
        ...
        console.log("FIRST SECURITY TOKEN IS GENERATED IN WELCOME.enteringInteractive!!");
        ...
        console.log("FIRST SECURITY TOKEN GENERATED AND SAVED IN STORAGE IN WELCOME.enteringInteractive!!");
        Storage.read("patientInfo").then(function(content) {
            User = JSON.parse(content);
            ...
            console.log("BEFORE CALLING /api/generateSecurityToken2 from WELCOME PAGE on enteringInteractive!!! with phone vlaue:" + User.Phone);
            ...
            console.log("BEFORE CALL generateSecurityToken2 IN WELCOME.enteringInteractive!!");
            fetch(url1, {
                method: 'POST',
                headers: {
                    "Content-type": "application/json",
                ...
                console.log("SECOND SECURITY TOKEN GENERATED AND SAVED IN WELCOME PAGE IN enteringInteractive!!");
                console.log("responseObject data: " + data);
...
function isLogged() {
    ...
    Storage.read("patientInfo").then(function(content) {
        ...
        console.log("BEFORE CALL generateSecurityToken on USER LOGGED!");
        fetch(url1, {
            method: 'POST',
            headers: {
                "Content-type": "application/json"
            ...
            console.log("BEFORE CALLING /api/generateSecurityToken2 from WELCOME PAGE on isLogged ON USER LOGGED IN!!! with phone vlaue:" + User.Phone);
            var url1 = activeUrl.URL + "/curandusproject/webapi/api/generateSecurityToken2";
            phone_obj = {
                "phone": User.Phone,
                "userType": "patient"
            ...
            console.log("BEFORE CALL generateSecurityToken2 IN WELCOME.iSLOGGED()!");
            fetch(url1, {
                method: 'POST',
                headers: {
                    "Content-type": "application/json",
                ...
                console.log("SECOND SECURITY TOKEN GENERATED AND SAVED IN WELCOME PAGE IN iSLOGGED()!");
                console.log("responseObject data: " + data);
                console.log("Before STORING IN tokenInfo!");
                // var tokenInfo = Observable();
                // tokenInfo.value = data;
        ...
        console.log("BEFORE CALL generateSecurityToken on USER NOT REGISTERED!  IN WELCOME.iSLOGGED-NOT REGISTERED()");
        fetch(url1, {
            method: 'POST',
            headers: {
                "Content-type": "application/json"
