...
//	}
	...
	public static void main(String[] args) throws Exception {
   	 ...
   	 java.util.Date utilDate1 = cal.getTime();
		 Providers p_provider = new Providers(7, "Anastasija2", "t", "middle", "Rancic", 
		...
		{   
			ProjectManager projectManager= new ProjectManager();
			System.out.println("init");
			projectManager.CheckProviderActivationKey("534" , "072806125" , 565656, "7e464757-7159-4a34-8beb-7ad4a9cc611b");
